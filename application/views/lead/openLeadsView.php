					...
					<table class="table table-bordered hover">
						...
						<?php
							...
							if(@$total_rows>0)
							{
								...
								{?>
									<tr>
										<td class="text-center" style="width:8%; <?php if($row['status'] == 19) { ?><?php } ?>"><?php echo @$row['lead_number'];?></td>
										<!-- <td style="width:20%;"><?php //echo @$row['customer'].$row['user_id'];?></td> -->
										<td style="width:20%;"><?php echo @$row['customer'];?></td>
										<td style="width:20%;"><?php echo @$row['contact'].$this->session->userdata('user_id');?></td>
										...
										<td class="text-center" style="width:7%;">
											...
											$edit = (($row['user_id'] == $this->session->userdata('user_id')) && $row['status'] != 19)?'fa-edit (alias)':'fa-edit (alias)';?>
