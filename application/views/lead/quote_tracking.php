                                ...
                                if (!empty($quoteSearch)) {
                                    ...
                                    foreach (@$quoteSearch as $quote_revision_id => $opportunities) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" rowspan="<?php echo count($opportunities);?>"><?php echo $row['quote_number'].' Rev-'.getQuoteRevisionNumber($row['quote_id'],$row['quote_revision_id']); ?></td>
                                                ...
                                                switch ($status_format) {
                                                    case 1: // Quote Status
                                                        if($j==0) {
                                                            ...
                                                            ?>
                                                        <td class="text-center" rowspan="<?php echo count($opportunities);?>" align='center'><?php echo $revision_status_label; ?></td>
                                                        <?php }
                                                    break;
