...
$checkRole = ($role_id == 4 || $role_id == 5 || $role_id == 6)?1:0;
            ...
            <?php
              ...
              if(@$total_rows>0)
              {
                ...
                {?>
                  ...
                  <tr>
                    <td class="text-center" style="width:4%;"><?php echo @$row1['opp_number'];?></td>
...
if(count(@$searchResults)>0)
 {
    foreach($searchResults as $row1)
    {
      ...
      {
        $action = SITE_URL.'updateOpportunityDistributorRole'; $pop_id = 'op_modal'.$row1['opportunity_id'];
      }
      else
      {
        $action = SITE_URL.'updateOpportunity'; $pop_id = 'op_modal'.$row1['opportunity_id'];
