						...
						<form class="form-horizontal" role="form" action="<?php echo SITE_URL.'assignInactiveUserLeads';?>" method="post">	
							<div class="form-group row">
								<div class="col-sm-12" style="margin-bottom:10px">
									<div class="col-sm-2">
									<input type="text" name="lead_id" placeholder="Lead ID" maxlength="20" value="<?php echo $searchParams['lead_id']; ?>" id="lead_id" class="form-control">	
									</div>
									<div class="col-sm-2">
									<input type="text" name="lead_number" placeholder="Lead Number" maxlength="20" value="<?php echo $searchParams['lead_number']; ?>" id="lead_number" class="form-control">	
									</div>
									<div class="col-sm-2">
								...
								<div class="col-sm-2">
									...
									<div class="col-sm-2">
										...
										<button type="submit" name="assignInactiveUserLeadsDownload" value="1" formaction="<?php echo SITE_URL;?>assignInactiveUserLeadsDownload" class="btn btn-success"><i class="fa fa-cloud-download"></i></button>
					...
					<table class="table table-bordered hover">
						<thead>
							<tr>
								...
								<th class="text-center"><strong>Lead Number</strong></th>
							...
							if(@$total_rows>0)
							{
								...
								{?>
									<tr>
										...
										<td class="text-center" style="width:7%;"><?php echo @$row['lead_number'];?></td>
