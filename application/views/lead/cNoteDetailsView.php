            ...
            <div class="step-content"> 
                    ...
                    <form class="form-horizontal" role="form" action="<?php echo SITE_URL;?>manageContractNotes" method="post">
    					<div class="form-group">
        					<div class="col-sm-4">
        						<input type="text" autocomplete="off" name="contract_note_id" value="<?php echo @$searchParams['contract_note_id'];?>" id="cNote_id" class="form-control" placeholder="CNOTE ID">
        					</div>
                            <div class="col-sm-1"> 
                                        ...
                                        ?>
                                            ...
                                            foreach($quotesInfo as $row1)
                                            {
                                                ...
                                                <tr>
                                                    ...
                                                    <?php } ?>
													<td class="text-center"><?php echo $row['lead_number'];?></td>
                                                    ...
                                                    <td rowspan="<?php echo $quotesCount; ?>" class="text-center">
                                                        ...
                                                        <a href="<?php echo SITE_URL; ?>deleteContractNote/<?php echo @icrm_encode($row['contract_note_id']); ?>&<?php echo @icrm_encode($row['cnote_number']); ?>" onclick="return confirm('Are you sure you want to delete?')" style="padding:3px 3px;" title="Delete Contract Note"><button type='button' class="btn btn-danger"  style="padding: 3px;" ><i class="fa fa-trash-o"></i></button></a>
