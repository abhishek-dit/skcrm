...
<ul class="steps">
	<a href="<?php echo $leadURL; ?>" style="cursor:pointer;">
		<li class="<?php echo $leadClass; ?>">Lead Details<span class="chevron"></span></li>
	</a>
	<?php
	if (@$checkUser && (@$lead_row['type'] == 2 && (@$lead_row['site_readiness_id'] == NULL || @$lead_row['relationship_id'] == NULL))) {

	?>
		<a data-target="#mod-warning" data-toggle="modal">
			<li class="">Opportunities<span class="chevron"></span></li>
		</a>
	<?php
	} else {
	?>
		<a href="<?php echo $opportunityURL; ?>">
			<li class="<?php echo $opportunityClass; ?>">Opportunities<span class="chevron"></span></li>
		</a>
	<?php
	}
	?>
	<!-- changes made on 17-06-2021 to Blocked for distributor role -->
	...
	<!-- changes made on 17-06-2021 to Blocked for distributor role end -->
</ul>