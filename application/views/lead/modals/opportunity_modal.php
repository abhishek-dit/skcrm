					...
					<div class="row">
						<div class="col-sm-6 col-md-6">
							<div class="formContentBlock">
								...
								<div class="form-group">
									...
									<?php echo form_dropdown('encoded_id', $leads, '',' id="leads" class="select2 " required'); ?>
								</div>
								<?php } ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control dateFromToday" <?php echo $fld_status;?> value="<?php echo @$row['expected_order_conclusion'];?>" autocomplete="off" name="expected_order_conclusion" placeholder="YYYY-MM-DD" required>
								</div>
									<div class="form-group">
									<label for="inputProductName">Expected Invoice Date</label>
									<input type="text" autocomplete="off" class="form-control dateFromToday" <?php echo $fld_status;?> value="<?php if(@$row['expected_invoicing_date']!='0000-00-00')echo @$row['expected_invoicing_date'];?>" name="expected_invoicing_date" placeholder="YYYY-MM-DD">
								</div>
								...
								<div class="form-group">
									...
									if(@$row['product_id']>0){
										...
										$Competitors = getCompetitorsByProductCategory(@$row['group_id']);
						...
						<div class="col-sm-6 col-md-6">
							<div class="formContentBlock">
								...
								<?php $remarks2_cls = (@$row['oppr_lost_id']==15||@$row['status']==8||@$row['status']==10)?'':'hidden';
