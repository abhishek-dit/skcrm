    ...
    <div class="row"> 
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                ...
                <div class="content">
                <form id="bulkUploadFrm1" action="<?php echo SITE_URL.'insert_product_stock_upload';?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
                     <div class="col-sm-12 col-md-12" style="margin-bottom:10px;">
                        <div class="col-md-9"><h3>Manage Stock In Hand</h3></div>
                        <div class="col-md-3"><a href="<?php echo SITE_URL.'download_product_stock_csv'?>" class="btn btn-primary"><i class="fa fa-cloud-download"></i> Stock In Hand XLSX</a></div>
                    </div>
                    ...
                    <div class="form-group">
                            ...
                            <div class="col-sm-2">
                               <a href="<?php echo SITE_URL.'product_stock_list'?>" class="btn btn-sm btn-primary">View Upload List</a>
                            </div>
                            <?php } ?>
                        </div>
                </form>
