								...
								<div class="content">
									<div class="form-horizontal">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
                                                <input type="text" required class="form-control name" id="name" placeholder="Product Code" name="name" value="<?php echo @$productEdit[0]['name']; ?>" maxlength="150">
											</div>
										</div>
										<div class="form-group">
				                            ...
				                            <div class="col-sm-6">
												...
												echo form_dropdown('category', $categories, @$productEdit[0]['category_id'],'class="select2 category" id="category" required '.$disabledText); ?>
											</div>
										</div>
										<div class="form-group">
											<label for="inputGroupName" class="col-sm-3 control-label">Segment <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<?php echo form_dropdown('group', $groups, @$productEdit[0]['group_id'],'class="select2 group" id="segment" required'); ?>
											</div>
										</div>
										<div class="form-group">
											<label for="inputGroupName" class="col-sm-3 control-label">Sub System <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<?php echo form_dropdown('sub_category', $sub_system, @$productEdit[0]['sub_category_id'],'class="select2" id="sub_system" required'); ?>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Product Name</label>
											<div class="col-sm-6">
												<input type="text" class="form-control product_name" id="name" placeholder="Product Name" name="product_name" value="<?php echo @$productEdit[0]['name2']; ?>" maxlength="150">
											</div>
										</div>
										<div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<?php echo form_dropdown('product_type_id', $product_type, @$productEdit[0]['product_type_id'],'class="select2 product_type" id="product_type" required'); ?>
											</div>
										</div>
										<div class="form-group">
										  <label for="inputName" class="col-sm-3 control-label">Target</label>
												<div class="col-sm-6">
										      <label class="radio-inline"> <input type="radio" id="product_target" <?php if(@$productEdit[0]['target']==1) { echo 'checked';}?>   name="target" value="1" class="icheck"> Yes</label> 
										      <label class="radio-inline"> <input type="radio" id="product_target" <?php if(@$productEdit[0]['target']==2) { echo 'checked';}?>  name="target" style="margin-left: 14px;" value="2" class="icheck"> No</label> 
											</div>
										</div>
										<div class="form-group">
										  <label for="inputName" class="col-sm-3 control-label">Availability</label>
												<div class="col-sm-6">
										      <label class="radio-inline"> <input type="radio" id="product_availability" <?php if(@$productEdit[0]['availability']==1 || $flg==1) { echo 'checked';}?>   name="availability" value="1" class="icheck"> Active</label> 
										      <label class="radio-inline"> <input type="radio" id="product_availability" <?php if(@$productEdit[0]['availability']==2) { echo 'checked';}?>  name="availability" value="2" class="icheck"> Inactive</label> 
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="number" min="0" required class="form-control only-numbers" id="mrp" placeholder="MRP" name="mrp" value="<?php echo @$productEdit[0]['mrp']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="inputBp" class="col-sm-3 control-label">Base Price <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" required class="form-control only-numbers" id="base_price" placeholder="Base Price" name="basePrice" value="<?php echo @$productEdit[0]['base_price']; ?>">
											</div>
										</div>
										<!-- <div class="form-group">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="number" required class="form-control" max-length="5" id="gst" placeholder="GST" name="gst" min="0" value="<?php echo @$productEdit[0]['gst']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="inputFreightInsurance" class="col-sm-3 control-label">Freight Insurance  In % <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" required min="0" class="form-control" max-length="5" id="freightInsurance" placeholder="Freight Insurance" name="freightInsurance" value="<?php echo @$productEdit[0]['freight_insurance']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="inputRrp" class="col-sm-3 control-label">RRP <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" required class="form-control only-numbers" max-length="20" min="0" id="rrp" placeholder="RRP" name="rrp" value="<?php echo @$productEdit[0]['rrp']; ?>">
											</div>
										</div>
										<div class="form-group">
											<label for="inputDp" class="col-sm-3 control-label">DP <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" required class="form-control only-numbers" max-length="20"  id="dp" placeholder="DP" name="dp" value="<?php echo @$productEdit[0]['dp']; ?>">
											</div>
										</div>

										<!-- Added on 18-06-2021 for adding new field for warranty based on product -->
										<div class="form-group">
											<label for="inputDp" class="col-sm-3 control-label">Warranty <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" required class="form-control only-numbers" max-length="20"  id="warranty" placeholder="Warranty" name="warranty" value="<?php echo @$productEdit[0]['warranty']; ?>">
											</div>
										</div>
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<textarea class="form-control" id="product_tech" name="features"><?php echo trim_ck_editor_data(@$productEdit[0]['features']); ?></textarea>
											</div>
										</div>
										<div class="form-group">
											<label class="col-sm-3 control-label">Scope of Supply</label>
											<div class="col-sm-6">
												<textarea class="form-control" id="product_scope" name="scope"><?php echo trim_ck_editor_data(@$productEdit[0]['scope']); ?></textarea>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-offset-3 col-sm-10">
												<button class="btn btn-primary" id="sub" type="submit" name="submitProduct" value="button"><i class="fa fa-check"></i> Submit</button>
...
<script>
	$(document).on("click",'#sub',function(){
		var code = $('.name').val();
		var product_code = window.btoa( code );
		var pro_category = $('#category:selected').val();
		var segment = $('#segment option:selected').val();
		var sub_system = $('#sub_system option:selected').val();
		var product_id = $('#product_id').val();
		var pro_name = $('.product_name').val();
		var product_name = window.btoa( pro_name );
		var pro_desc = $('#description').val();
		var product_description = window.btoa( pro_desc );
		var product_type = $('#product_type').val();
		var product_target = $('#product_target:checked').val();
		var product_availability = $('#product_availability:checked').val();
		var pro_mrp = $('#mrp').val();
		var product_mrp = window.btoa( pro_mrp );
		var pro_base_price = $('#base_price').val();
		var product_bp = window.btoa( pro_base_price );
		var pro_gst = $('#gst').val();
		var product_gst = window.btoa( pro_gst );
		var pro_ft = $('#freightInsurance').val();
		var product_ft = window.btoa( pro_ft );
		var pro_rrp = $('#rrp').val();
		var product_rrp = window.btoa( pro_rrp );
		var pro_dp = $('#dp').val();
		var product_dp = window.btoa( pro_dp );

		var pro_warranty = $('#warranty').val();
		var product_warranty = window.btoa( pro_warranty );

		//var pro_tech = $('.product_tech').val();
		var pro_tech = $('#product_tech').val();
		var product_tech = window.btoa(unescape(encodeURIComponent(pro_tech)));

		var pro_scope = $('#product_scope').val();
		var product_scope = window.btoa(unescape(encodeURIComponent(pro_scope)));
		var data = 'name='+product_code+'&product_name='+product_name+'&group='+segment+'&description='+product_description+'&mrp='+product_mrp+'&basePrice='+product_bp+'&sub_category='+sub_system+'&gst='+product_gst+'&freightInsurance='+product_ft+'&rrp='+product_rrp+'&dp='+product_dp+'&features='+product_tech+'&scope='+product_scope+'&product_type_id='+product_type+'&availability='+product_availability+'&target='+product_target+'&product_id='+product_id+'&warranty='+product_warranty;
		$.ajax({
	        type:"POST",
	        url:SITE_URL+'productAdd',
	        data:data,
	        cache:false,
	        success:function(){
...
<script>
     $(document).on("change",".category",function() {		
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo SITE_URL;?>getProductGroup_for_products",
