        ...
        <div class="block-flat">
            <div class="content">
                    <div class="col-sm-12 col-md-12" style="margin-bottom:10px;">
                        <div class="col-md-9"><h3>Missing Product Price Files</h3></div>
                        <div class="col-md-3">
                        	<a href="<?php echo SITE_URL;?>download_missing_product_list_files/<?php echo @icrm_encode($upload_id); ?>" class="btn btn-primary">Download Missing Files XLS</a>
                        </div>
                    </div>
                
                    <div class="table-responsive">
						<table class="table table-bordered hover" width="100%">
							<thead>
								<tr>
									...
									<!-- <th class="text-center"><strong>Features</strong></th>
									<th class="text-center"><strong>Scope</strong></th> -->
									<th class="text-center"><strong>MRP</strong></th>
									<th class="text-center"><strong>Base Price</strong></th>
									<!-- <th class="text-center"><strong>ED</strong></th>
									<th class="text-center"><strong>VAT</strong></th> -->
									<th class="text-center"><strong>Freight Insurance</strong></th>
									<th class="text-center"><strong>GST</strong></th>
									<th class="text-center"><strong>RRP</strong></th>
					...
					<div class="row">
						<div class="col-sm-offset-11 col-sm-2">
							<a href="<?php echo SITE_URL;?>product_bulk_upload" class="btn btn-primary" style="padding:6px 6px;" align="right"> <i class="fa fa-arrow-left" ></i>back</a>
						</div>
					</div>
            </div>              
        </div>
