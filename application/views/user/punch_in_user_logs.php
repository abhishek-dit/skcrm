    ...
    <div class="row"> 
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                ...
                <div class="content">
                    <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL; ?>punch_in_report">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" align="right">
                                        ...
                                        <a href="<?php echo SITE_URL;?>punch_in_report"><button type="button" class="btn btn-primary" ><i class="fa fa-refresh"></i></button></a>
                                        <button type="submit" name="downloadUserLogs" title="" class="btn btn-success" formaction="<?php echo SITE_URL; ?>download_punch_in_report" value="downloadUser"><i class="fa fa-cloud-download"></i> </button>
