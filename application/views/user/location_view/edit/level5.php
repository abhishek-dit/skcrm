...
<div class="form-group district-group <?php echo $district_hidden_cls;?>">
     <input type="hidden" name="district_parent" class="district_parent_hidd">
                    ...
                    foreach ($cur_states as $state) {
                        ...
                        if(count($districts)>0){
                            foreach ($districts as $district) {
                                ...
                                echo '<input type="hidden" class="district_parent" value="'.$district['location_id'].'k'.$state['location_id'].'" >';
                            }
                        }
                    }
                }
...
<input type="hidden" name="city_parent" class="city_parent_hidd">
                                ...
                                foreach ($districts as $district) {
                                    ...
                                    if(count($cities)>0){
                                        foreach ($cities as $city) {
                                            ...
                                            echo '<input type="hidden" class="city_parent" value="'.$city['location_id']."k".$district['location_id'].'" >';
                                        }
                                    }
                                    }
