...
if (@$flg != '') {
    ...
    if ($flg == 1) {
        ...
        elseif ($val == 2) {
            $formHeading = 'View Customer Details';
        } 
        else {
            ...
            <div class="col-sm-12 col-md-12">
                <div class="block-flat">
                    ...
                    <div class="content">
                            ...
                            <input type="hidden" name="edit_name" value="<?php echo @$customer_data[0]['name']?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    ?>
                                    <input type="text" <?php echo $customer_code_disable; ?>  required class="form-control" maxlength="100" id="customer_name" value="<?php echo @$customer_data[0]['name']; ?>"  name="name"  placeholder="Hospital Name" >
                                    <p id="customerNameValidating" class="hidden"><i class="fa fa-spinner fa-spin"></i> Checking...</p>
                                <p id="customerNameError" class="error hidden"></p>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-3 control-label">No. Of Beds</label>
                                <div class="col-sm-6">
                                    <?php
                                    if (isset($customer_data[0]['customer_bed_id'])) {
                                        $bed_id = $customer_data[0]['customer_bed_id'];
                                    } else {
                                        $bed_id = "";
                                    }
                                    $attrs = $disabledSelect . 'class="form-control bed_id" id="bed_id"  ';
                                    echo form_dropdown("bed_id", $cust_beds, $bed_id, $attrs);
                                    ?>

                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Speciality Offered</label>
                                <div class="col-sm-6">
                                    <select class="selectpicker select2 form-control"  name="speciality_id[]" id="speciality_id" multiple data-live-search="true"> 
                                        <?php foreach ($cust_speciality as $key => $speciality) 
                                        {  ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <input type="text" <?php echo $disabledText; ?>  maxlength="10"  class="form-control only-numbers" id="telephone" value="<?php echo @$tel; ?>"  name="telephone" placeholder="Telephone" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="number" <?php echo $disabledText; ?>  class="form-control" maxlength="30" id="gst" value="<?php echo @$customer_data[0]['latitude']; ?>"  name="latitude" placeholder="Latitude">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">Longitude</label>
                                <div class="col-sm-6">
                                    <input type="number" <?php echo $disabledText; ?>  class="form-control" maxlength="30" id="gst" value="<?php echo @$customer_data[0]['longitude']; ?>"  name="longitude" placeholder="Longitude">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                if ($editCheck == 0) {
                                    ...
                                    $redirect = ($parent == 1 || $parent == 2) ? 'newLead' : 'customer';
                                    $role_id = $this->session->userdata('role_id');
                                    ?>
                                        ...
                                        {
                                            ?>
                                            <a class="btn btn-danger" href="<?php echo SITE_URL.'approveCustomers'; ?>"><i class="fa fa-times"></i> Cancel</a> <?php
                                        }
                                        else
                                        {
                                            ?>
                                    ...
                                    {
                                        ?>
                                        <a class="btn btn-Primary" href="<?php echo SITE_URL .'customer'; ?>"><i class="fa fa-reply"></i> Back</a> <?php
                                    }
                                    ?>    
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" autocomplete="off" name="s_customerName" maxlength="100" placeholder="Name" value="<?php echo @$search_data['customerName']; ?>" id="companyName" class="form-control">
                                    </div>
                            ...
                            <div class="col-sm-12">
                                ...
                                <label class="col-sm-2 control-label">Location</label>
                                    ...
                                    <div class="col-sm-4" align="left">
                                        ...
                                        <a href="<?php echo SITE_URL;?>customer"><button type="button" class="btn btn-primary" ><i class="fa fa-refresh"></i></button></a>
                            ...
                            <tbody>
                                ...
                                if (@count($customerSearch) > 0) 
                                {
                                    foreach ($customerSearch as $row) 
                                    {
                                        ...
                                        ?>
                                        <tr>
                                            <td class="text-center" style="width:5%"><?php echo @$sn++; ?></td>
                                            <td style="width:30%"><?php echo @$row['name']; ?></td>
                                            <td class="text-center"  style="width:12%"><?php echo @$row['telephone']; ?></td>
                                            <td class="text-center"  style="width:12%"><?php echo getPhoneNumber(@$row['mobile']); ?></td>
...
$('#customer_name').blur(function(){
    ...
    if(customer_name!='')
    {
        ...
        var data = 'customer_name='+customer_name+'&customer_id='+customer_id;
    
        $.ajax({
            type:"POST",
            url:AJAX_CONTROLLER_URL+'is_customerNameExist',
            data:data,
            cache:false,
            ...
            { 
                ...
                {
                    $('#customer_name').val('');
                    $('#customerNameError').html('Customer Name <b>'+customer_name+'</b> already existed');
                    $("#customerNameError").removeClass("hidden");
                    return false;
                }
                else
                {   
                    $('#customerNameError').html('');
                    $("#customerNameError").addClass("hidden");
                    return false;
                }
            }
        });
