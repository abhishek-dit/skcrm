...
if (@$flg != '') {
    ...
    if ($flg == 1) {
        ...
        elseif ($val == 2) {
            $formHeading = 'View Contact Details';
        } 
        else {
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select style="width:100%" required class="checkCustomer" name="customer_id" <?php echo $dis; ?>  id="customer">
                                        <?php
                                        if (isset($contact_data[0]['customer_id'])) {
                                            ?>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-10">
                                            ...
                                            if ($editCheck == 0) {
                                                ...
                                                $redirect = ($parent == 1 || $parent == 2) ? 'newLead' : 'contact';
                                                ?>
                                    ...
                                    {
                                        ?>
                                        <a class="btn btn-Primary" href="<?php echo SITE_URL .'contact'; ?>"><i class="fa fa-reply"></i> Back</a> <?php
                                    }
                                    ?>    
                                </div>
                            </div>
...
if (@$displayList == 1) {
    ...
    <?php echo form_dropdown('c_speciality', $SpecialityInfo, @$searchParams['c_speciality'], 'class="select2"'); ?>
                                ...
                                <div class='col-sm-3'>
                                    ...
                                    <a href="<?php echo SITE_URL;?>contact"><button type="button" class="btn btn-primary" ><i class="fa fa-refresh"></i></button></a>
                                ...
                                if (@count($contactSearch) > 0) {
                                    foreach ($contactSearch as $row) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center" width="15%"><?php echo @$row['first_name']; ?></td>
                                            <td class="text-center" width="25%"><?php echo @$row['customer']; ?></td>
                                            <td class="text-center" width="4%"><?php echo @$row['speciality']; ?></td>
                                            <td class="text-center" width="4%"><?php echo @$row['email']; ?></td>
                                            <td class="text-center" width="10%"><?php echo getPhoneNumber(@$row['mobile_no']); ?></td>
