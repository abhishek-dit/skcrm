...
<table  width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" >
    ...
    <tr> <td width="5">&nbsp;</td>
        <td width="99%">
            <br>
            <p>For further details on our local sales and services offices please visit our website <a href="https://www.skanray.com" target="_blank">www.skanray.com</a>
            </p>
            <p>You may also call our Toll Free Customer Interaction Centre on 1800-425-7002 between 10AM to 6:45PM on all weekdays or email your queries to <a href="https://cic@skanray.com" target="_blank">cic@skanray.com</a>
            </p>
            <br>
        </td> <td width="5">&nbsp;</td>
    </tr>
        ...
        <td>
            <table width="100%" border="1" class="table_border" cellspacing="0" cellpadding="2">
                <tr>
                    ...
                    <th width="40%" style=""><strong>Material Description</strong></th>
                    <th width="13%" style=""><strong>Unit Price</strong></th>
                    <th width="11%" style=""><strong>Warranty (Months)</strong></th>
                    <th width="5%" style=""><strong>Qty</strong></th>
                    <th width="10%" style=""><strong>Total Price</strong></th>
                </tr>
                <?php
                $cnt = 1;
                ...
                $cnt++; ?></td>
                            ...
                            <td width="40%" style="" valign="top"> <?php echo $product['description'];?></td>
                            <td width="13%" style="" valign="top" align="right"><strong><?php echo indian_format_price($mrp); ?></strong></td>
                            <td width="11%" style="" valign="top" align="center"><strong><?php echo $product['warranty']; ?></strong></td>

                            <td width="5%" style="" valign="top" align="center"><strong><?php echo $product['qty']; ?></strong></td>
                            <td width="10%" style="" valign="top" align="right"><strong><?php echo indian_format_price($total_amt); ?></strong></td>
                        </tr>
                        <?php
                    }
