...
<table  width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" >
    ...
    <tr> <td width="5">&nbsp;</td>
        <td><p>Thank you for your interest in Skanray’s products. We are confident that our products will satisfy your clinical requirements. 
            ...
            <p><?php echo '[QUOTE_CREATOR_NAME]'; ?><?php if($quotation['roleCheck'] == 1) { ?><br><?php echo '[QUOTE_CREATEOR_ROLE]'; } ?></p></p><span style="font-size:8px">*This is an electronically generated quotation, no signature required.</span>
    ...
    <tr> <td width="5">&nbsp;</td>
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="2">
                ...
                $cnt++; ?></td>
                            <td width="17%" style="font-size:8px" valign="top"></td>
                            <td width="<?php echo $description_width;?>%" style="font-size:8px" valign="top"></td>
                            <td width="13%" style="font-size:8px" valign="top" align="right"></td>
                            <td width="5%" style="font-size:8px" valign="top" align="center"></td>
                            <td width="13%" style="font-size:8px" valign="top" align="right"></td>
                        </tr>
                        <?php
                    }
    ...
    <tr> <td width="5">&nbsp;</td>
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    <td width="5%" align="center" valign="top">&nbsp;</td>
                    <td  width="<?php echo $sub_total_width?>%">Add  Freight& Insurance@<strong>[F&I]%</strong>
                    </td>
                    ...
                    <tr>
                        <td width="5%" align="center" valign="top">&nbsp;</td>
                        <td  width="<?php echo $sub_total_width?>%">Add GST @<strong>[GST]%</strong>
                        </td>
                        <td valign="top" align="right" width="13%"  style="font-size:8px" >
                            <strong></strong>
                        </td>
                ...
                <tr>
                    <td width="5%" align="center" valign="top">&nbsp;</td>
                    <td width="<?php echo $sub_total_width?>%">Total Price in words - Indian Rs)
                    </td>
                        ...
                        <ol>
                            ...
                            switch ($quote_format_type) {
                                ...
                                case 2: // New Format
                                    ...
                                    {
                                        ?>
                                    <li>Payment terms: ____ advance and balance in ____ days from invoice</li>
                                        <?php
                                    }
                                    ?>
                                    <li>Validity: 30 days from the date of offer.</li>
                                    <li>Warranty: <?php echo '____ Months';?> from date of invoice </li>
                                    <li>Other Terms & Conditions, as per enclosed Terms & Conditions of Sale (Supply only)</li>
                                    <?php
                                break;
                            }
            ...
            for($i=1;$i<=3;$i++) {
                 {
                    ...
                    <h2><?php echo $k . '. [PART_NO] - [PRODUCT_NAME]'; ?></h2>


                    <h4>Technical Specifications</h4>
        <?php
        echo '[TECHNICAL_SPEC_INFO]';
        ?>
                </td> <td width="5">&nbsp;</td>
            </tr>
            <tr> <td width="5">&nbsp;</td>
