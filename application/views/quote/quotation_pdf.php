...
<table  width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" >
    ...
    <tr> <td width="5">&nbsp;</td>
        <td><p>Thank you for your interest in Skanray’s products. We are confident that our products will satisfy your clinical requirements. 
            ...
            <?php if($quotation['quote_creator']['role'] == 'Distributor'){ ?>
            <p>Yours truly,<br>
            <?php
            echo $quotation['lead_owner']['distributor_name'];
            ?>
            <?php } else { ?>
            <p>Yours truly,<br>
            <?php if($quotation['roleCheck'] == 1) { ?>
            Skanray Technologies Pvt. Ltd
            <?php } 
            else
            { 
            echo $quotation['lead_owner']['distributor'];
            } ?><br><br>
            <?php } ?>
            <p><?php if($quotation['roleCheck'] == 1) { ?><?php echo $quotation['quote_creator']['name']; ?><br><?php echo $quotation['quote_creator']['role']; } ?></p></p>
            <span style="font-size:8px"><b>*This is an electronically generated quotation, no signature required.</b></span>
