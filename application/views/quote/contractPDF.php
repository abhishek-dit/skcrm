        ...
        <td colspan="2">
            <table width="540" border="1" cellspacing="0" cellpadding="1">
                <tr>
                    ...
                    <td  width="15%"  align="center"><strong>Unit Price (<?php echo $currency_name; ?>)</strong></td>
                    <td  width="17%" align="center"><strong>Total Price (<?php echo $currency_name; ?>.)</strong></td>
                </tr>
                <?php 
				$pro_cnt=1;
				$grand_total=0;
                                ...
                                case 2: // New CNote Format
                                   ...
                                   ?>
                                    <tr>
                                        ...
                                        {
                                            ?>
                                        <td width="70%" align="center"><strong>Payment terms: 100% advance along with confirmed order</strong></td>
                                            <?php
                                        }
                                        else
                                        {
                                            ?>
                                        <td width="70%" align="center"><strong>Payment terms: <?php echo format_advance($quotes[0]['advance'],$quotes[0]['advance_type']);?> advance and balance in <?php echo $quotes[0]['balance_payment_days'];?> days from invoice</strong></td>
                                            <?php
                                        }
                                        ?>
                                    </tr>
                                    ...
                                    <tr>
                                        <td align="center"><strong>Warranty: <?php echo $quotes[0]['warranty'].' Months';?></strong></td>
                                    </tr>

                                   <?php
                                    if(@$lead_user['role_id']!=5) // If lead owner is not Distributor
                                    {
                                        ?>
                                        <tr>
                                            <td align="center"><strong>Distibutor ORC: <?php echo round($quotes[0]['dealer_commission'],2).'%';?></strong></td>
                                        </tr>
                                        <?php
                                    }
                                break;
