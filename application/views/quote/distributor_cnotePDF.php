        ...
        <td>
            <table width="590" border="1" cellspacing="0" cellpadding="1">
                ...
                <tr>
                    ...
                    <td width="160" bgcolor="#F0F0F0"><?php echo @$po_number; ?></td>
                </tr>
                <tr>
        ...
        <td colspan="2">
            <table width="540" border="1" cellspacing="0" cellpadding="1">
                <tr>
                    ...
                    <td  width="16%"  align="center"><strong>Unit Price (<?php echo $currency_name; ?>.)</strong></td>
                    <td  width="16%" align="center"><strong>Total Price (<?php echo $currency_name; ?>.)</strong></td>
                </tr>
                <?php 
				$pro_cnt=1;
				$grand_total=0;
