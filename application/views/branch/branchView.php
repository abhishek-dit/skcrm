                    ...
                    <?php echo validation_errors(); ?>
                        <form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>branchAdd"  parsley-validate novalidate method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control load_iCheck" required name="geo" id="geo">
                            ...
                            <div class="form-group region-group hidden">
                                <label class="col-sm-3 control-label">Region <span class="req-fld">*</span></label>
                                <div class="col-sm-6">
    ...
    <div class="row"> 
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                ...
                <div class="content">
                    <div class="row">
                        <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL; ?>branch">
                            <div class="col-sm-12">

                                <label class="col-sm-2 control-label">Branch</label>
                                <div class="col-sm-2">
                                    <input type="text" name="branchName" value="<?php echo @$searchParams['branchName']; ?>" id="branchName" class="form-control" placeholder="Name"  maxlength="100">
                                </div> 
                                <div class="col-sm-4">
                                    <button type="submit" title="Search" name="searchbranch" value="1" class="btn btn-success"><i class="fa fa-search"></i> </button>
                                    <a href="<?php echo SITE_URL.'branch'; ?>" class="btn btn-success"><i class="fa fa-refresh"></i></a>
                                    <button type="submit" name="downloadbranch" value="1" title="Download" formaction="<?php echo SITE_URL; ?>downloadBranch" class="btn btn-success"><i class="fa fa-cloud-download"></i> </button>
                                    <a href="<?php echo SITE_URL; ?>addBranch" title="Add New" class="btn btn-success"><i class="fa fa-plus"></i> </a>
                                </div>
                            </div>
                        </form>
                    </div>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-default" style="padding:3px 3px;" href="<?php echo SITE_URL; ?>editBranch/<?php echo @icrm_encode($row['branch_id']); ?>"><i class="fa fa-pencil"></i></a> 
                                        <?php
                                        if (@$row['status'] == 1) {
                                            ?>
                                                    <a class="btn btn-danger" style="padding:3px 3px;" href="<?php echo SITE_URL; ?>deleteBranch/<?php echo @icrm_encode($row['branch_id']); ?>" onclick="return confirm('Are you sure you want to Delete?')"><i class="fa fa-trash-o"></i></a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a class="btn btn-info" title="Activate" style="padding:3px 3px;" href="<?php echo SITE_URL; ?>activateBranch/<?php echo @icrm_encode($row['branch_id']); ?>"  onclick="return confirm('Are you sure you want to Activate?')"><i class="fa fa-check"></i></a>
                                                    <?php
                                                }
                                                ?>
                                            </td>
