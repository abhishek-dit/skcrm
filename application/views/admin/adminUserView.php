						...
						<div class="block-flat">
							...
							<div class="content">
								<form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>adminUserAdd"  parsley-validate novalidate method="post">
									<input type="hidden" name="user_id" id="user_id" value="<?php echo @$adminUserEdit['user_id']?>">
									<div class="form-group">
										<?php $disable = (@$adminUserEdit['employee_id'] != '')?'readonly':''; ?>
										<label for="inputName" class="col-sm-3 control-label">Employee ID <span class="req-fld">*</span></label>
										<div class="col-sm-6">
											<input type="text" maxlength="50" <?php //echo $disable; ?> class="form-control" required name="employee_id" id="employee_id" placeholder="Employee ID" value="<?php echo @$adminUserEdit['employee_id']; ?>">
										...
										<div class="col-sm-6">
											<select name="company_id" required class="form-control select2">
		                                        ...
		                                        <?php 
		                                            ...
		                                            {
		                                                $selected = $row['company_id']==@$adminUserEdit['company_id']?'selected':'';
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" required maxlength="50" class="form-control" id="first_name" value="<?php echo @$adminUserEdit['first_name']; ?>"  name="first_name"  placeholder="First Name" >
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Last Name<span class="req-fld">*</span></label>
										<div class="col-sm-6">
											<input type="text" required maxlength="50" class="form-control" id="last_name" value="<?php echo @$adminUserEdit['last_name']; ?>"  name="last_name"  placeholder="last_name" >
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-sm-1">
		                                    <?php
		                                    $mobile[0] = "91";
		                                    if (@$adminUserEdit['mobile_no'] != NULL) {
		                                        $mobile = explode("-", @$adminUserEdit['mobile_no']);
		                                    }
									...
									<div class="form-group">
										...
										<div class="col-sm-6">
											<input type="text" required class="form-control" parsley-type="email" maxlength="100" id="email_id" value="<?php echo @$adminUserEdit['email_id']; ?>"  name="email_id"  placeholder="Email ID" >
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Address </label>
										<div class="col-sm-6">
											<textarea class="form-control" maxlength="255" id="address1" name="address1" placeholder="Address"><?php echo @$adminUserEdit['address1']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Address 1</label>
										<div class="col-sm-6">
											<textarea class="form-control" id="address1" maxlength="255"  name="address2" placeholder="Address 1" ><?php echo @$adminUserEdit['address2']; ?></textarea>
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">State</label>
										<div class="col-sm-6">
											<input type="text" maxlength="100" class="form-control" id="state" value="<?php echo @$adminUserEdit['state']; ?>"  name="state" placeholder="State" >
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">City</label>
										<div class="col-sm-6">
											<input type="text" maxlength="100" class="form-control" id="city" value="<?php echo @$adminUserEdit['city']; ?>"  name="city" placeholder="City">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label">Branch <span class="req-fld">*</span> </label>
										<div class="col-sm-6">
											<?php echo form_dropdown('branch_id', $branch, @$adminUserEdit['branch_id'],'required class="select2"'); ?>
										</div>
									</div>
				...
				<form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>adminUser">
					<div class="row">
						<div class="col-sm-12">
                            ...
                            <div class="col-sm-2">
								<?php echo form_dropdown('adminUserCompany', $companies, @$searchParams['adminUserCompany'],'class="form-control select2"'); ?>
							</div>
								...
								{?>
									<tr>
										...
										<td class="text-center"><?php echo @$row['mobile_no'];?></td>
											...
											{
												?>
												<a class="btn btn-danger" style="padding:3px 3px;" href="<?php echo SITE_URL;?>deleteAdminUser/<?php echo @icrm_encode($row['user_id']); ?>" onclick="return confirm('Are you sure you want to De-Activate?')"><i class="fa fa-trash-o"></i></a>
												<?php
											}
											else
											{
