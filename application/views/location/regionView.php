							...
							<div class="block-flat">
								...
								<div class="content">
									<form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>locationAdd"  parsley-validate novalidate method="post">
										...
										<div class="form-group">
											<label for="inputName" class="col-sm-3 control-label">Latitude <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="text" name="latitude" class="form-control" placeholder="Latitude" value="<?php echo @$regionEdit[0]['latitude'] ?>" required>
											</div>
										</div>
										<div class="form-group">
											<label for="inputName" class="col-sm-3 control-label">Longitude <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="text" name="longitude" class="form-control" placeholder="Longitude" value="<?php echo @$regionEdit[0]['longitude'] ?>" required>
											</div>
										</div>
										<div class="form-group">
