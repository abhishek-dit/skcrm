...
<div class="row"> 
    <div class="col-sm-12 col-md-12">
        <div class="block-flat">
            <div class="content">
            <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>fresh_business_report">
                <div class="header">
                    <div class="row">
                        <div class="form-group">
                            <div class="col-sm-12">
                               ...
                               <div class="col-sm-2">
                                    ...
                                    <input type="hidden" name="vtime" id="vtime" value="">
                                </div> 
                                ...
                                <button type="submit" name="download_fresh_business_report" value="1" formaction="<?php echo SITE_URL;?>download_fresh_business_report" class="btn btn-success"><i class="fa fa-cloud-download"></i></button>
