...
function filterReport() {
    ...
    //alert(year_text);
   // alert(region_filter);
    var data = 'from_date='+from_date+'&to_date='+to_date+'&vtime='+vtime+'&report_by='+report_by+'&duration='+duration+'&duration_text='+duration_text+'&users='+users+'&region_filter='+region_filter+'&segment='+segment+'&year_text='+year_text;
    //alert(data);
    $.ajax({
