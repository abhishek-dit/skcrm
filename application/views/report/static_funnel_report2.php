...
function filterReport() {
    ...
    $.ajax({
        url: SITE_URL + 'static_filter_funnel_chart',
        type:"POST",
        data:data,
        dataType:'json', 
        success: function(data){
...
var chart1Data1 = <?php echo $chart1Data1;?>;
first_chart1(chart1Data1);
function first_chart1(chart1Data1) 
{
    console.log(chart1Data1);
    xAxisCategory = chart1Data1['xAxisCategory'];
    yAxisCategory = chart1Data1['yAxisCategory'];
    chart1Series = chart1Data1['chart1Series'];
    xAxisLable = chart1Data1['xAxisLable'];
    topPosition= chart1Data1['tpoPosition'];
...
function second_chart(category,name)
{
    ...
    $.ajax({
        url: SITE_URL + 'static_funnel_chart2',
        type:"POST",
        data:data,
        dataType:'json', 
        success: function(data){
