...
<div class="row"> 
	<div class="col-sm-12 col-md-12">
		<div class="block-flat">
			...
			<div class="content">
				<div class="row">
					<form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>order_lost_analysis_report">
						<div class="col-sm-12">
                                <!--<div class="col-sm-2">
							...
							<div class="col-sm-3">
                                ...
                                <div class="col-sm-2">
                                    <button type="submit" name="searchOrderLostAnalysis" value="1" class="btn btn-success"><i class="fa fa-search"></i></button>
                                    <?php if(in_array($role_id, allowed_download_roles()))
                                            { ?>
                                    <button type="submit" name="order_lost_analysis_report_download" value="1" formaction="<?php echo SITE_URL;?>order_lost_analysis_report_download" class="btn btn-success"><i class="fa fa-cloud-download"></i></button>
                                    <?php } ?>
                                    <a href="<?php echo SITE_URL.'order_lost_analysis_report'; ?>" class="btn btn-success"><i class="fa fa-refresh"></i></a>
                                </div>
                            </div>
						</div>
					</form>
					...
					<table class="table table-bordered hover">
						<thead>
							<tr>
                                ...
                                <th class="text-center"><strong>Leaad Owner Name</strong></th>
								...
								{?>
                                    ...
                                    <tr class="details">
                                        ...
                                        <table class="table">
                                            ...
                                            <td class="text-center" width="10%"><?php echo @$row1['reason'];?></td>
										    <td class="text-center" width="10%"><?php echo @$row1['productName'];?></td>
                                            <td class="text-center" width="10%"><?php echo @$row1['value'];?></td>
                                            </tr>
                                            <?php }?>
                                            </tbody>
                                        </table>    
