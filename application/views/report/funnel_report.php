...
<div class="row"> 
	<div class="col-sm-12 col-md-12">
		<div class="block-flat">
			<div class="content">
            <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>funnel_report">
				<div class="header">
                           ...
                           <!--  <div class="col-sm-2 custom_icheck" style="padding-left: 0px !important">
                             ...
                             <?php   } ?>
                               <div class="col-sm-2">
                                ...
                                <button type="submit" name="download_funnel_report" value="1" formaction="<?php echo SITE_URL;?>download_funnel_report" class="btn btn-success"><i class="fa fa-cloud-download"></i></button>                              
                            </div>
                        </div>
                    </div>
                </div>
