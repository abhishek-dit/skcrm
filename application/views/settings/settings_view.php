							...
							<form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>incentive_insert_settings"  parsley-validate novalidate method="post">
								<div class="form-group">
									...
									<div class="col-md-6">
										...
										<div class="col-sm-6">
			                                <select class="form-control select2 role" required style="width:100%" name="role_id">
								...
								<div class="form-group">
									<div class="col-md-6">
										...
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Quarter Incentive" name="value">
										</div>
									</div>
									<!-- <div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Upper Value" name="upper_value" >
										</div>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-md-6">
										...
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Primary Product Lower Limit" name="gradea_pp_ll" >
										</div>
									</div>
									<div class="col-md-6">
										<label for="inputFinancialYear" class="col-sm-4 control-label">PP UL <span class="req-fld">*</span></label>
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Primary Product Upper Limit" name="gradea_pp_ul" >
										</div>
									</div>
								</div>
								<div class="form-group">
									<div class="col-md-6">
										...
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Secondary Product Lower Limit" name="gradea_sp_ll" >
										</div>
									</div>
									<div class="col-md-6">
										<label for="inputFinancialYear" class="col-sm-4 control-label">SP UL <span class="req-fld">*</span></label>
										<div class="col-sm-6">
											<input type="number" min="0" required class="form-control" placeholder="Secondary Product Upper Limit" name="gradea_sp_ul" >
										</div>
									</div>
								</div>
								<div class="grade_b hidden">
									<div class="form-group">
										...
										<div class="col-md-6">
											<label for="inputFinancialYear" class="col-sm-4 control-label">PP LL <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" class="form-control req" placeholder="Primary Product Lower Limit" name="gradeb_pp_ll" >
											</div>
										</div>
										<div class="col-md-6">
											<label for="inputFinancialYear" class="col-sm-4 control-label">PP UL <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" class="form-control req" placeholder="Primary Product Upper Limit" name="gradeb_pp_ul" >
											</div>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-6">
											<label for="inputFinancialYear" class="col-sm-4 control-label">SP LL <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" class="form-control req" placeholder="Secondary Product Lower Limit" name="gradeb_sp_ll" >
											</div>
										</div>
										<div class="col-md-6">
											<label for="inputFinancialYear" class="col-sm-4 control-label">SP UL <span class="req-fld">*</span></label>
											<div class="col-sm-6">
												<input type="number" min="0" class="form-control req" placeholder="Secondary Product Upper Limit" name="gradeb_sp_ul" >
											</div>
										</div>
									</div>
								</div>
