...
class Commission extends Base_controller {
	...
	/**
	* Fetching Commission report details
	 *return: $commission_list(array)
	**/
	...
	#Adding Add Dealer Payment Details
			...
			foreach ($cnote_id as $key => $value) 
                {
					...
					#Inserting Details into Dealer Commission report
