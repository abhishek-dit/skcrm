...
class Campaign extends Base_controller {
    ...
    **/
    ...
    public function addCampaign() {
        ...
        #Fetching Speciality results
        $data['specialityInfo'] = $this->Common_model->get_dropdown('speciality', 'speciality_id', 'name',array('company_id'=>$this->session->userdata('company')));
        $data['locations'] = array('' => 'Select Location') + $this->Common_model->get_dropdown("location", "location_id", "location", array('territory_level_id' => 7));
    ...
    **/
    public function editCampaign($encoded_id) {
        ...
        $data['flg'] = 1;
        $data['val'] = 1;
        # Load page with all campaign details
        $this->load->view('campaign/campaignView', $data);
    }
    /**
    * Adding New Campaign 
    * Inserting Campaign Details
    * return: $campaign_id
    **/
    ...
    public function addCampaignDocuments() {
        # Data Array to carry the require fields to View and Model
        $data['nestedView']['heading'] = "Manage Documents";
        $data['nestedView']['cur_page'] = 'Documents';
        ...
        $data['specialityInfo'] = array('' => 'Select Speciality') + $this->Common_model->get_dropdown('speciality', 'speciality_id', 'name', array('company_id'=>$_SESSION['company']));
        $data['locations'] = array('' => 'Select Location') + $this->Common_model->get_dropdown("location", "location_id", "location", array('territory_level_id' => 7));
    ...
    #Inserting New Campaign Documents into DB
