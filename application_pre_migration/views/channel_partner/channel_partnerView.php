                ...
                <div class="block-flat">
                    ...
                    <?php echo validation_errors(); ?>
                        <form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>channel_partnerAdd"  parsley-validate novalidate method="post">
                            <input type="hidden" id="channel_partner_id" name="channel_partner_id" value="<?php echo @icrm_encode($channel_partnerEdit['channel_partner_id']); ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" required name="ac_no" placeholder="Bank Account Number" value="<?php echo @$channel_partnerEdit['account_number'];?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">IFSC <span class="req-fld">*</span></label>
                                <div class="col-sm-6">
                                    <input type="text" required class="form-control" name="ifsc" placeholder="IFSC Code" value="<?php echo @$channel_partnerEdit['ifsc_code'];?>">
                                </div>
                            </div>
                            <div class="form-group">
