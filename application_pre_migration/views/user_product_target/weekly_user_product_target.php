    ...
    <div class="row"> 
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                ...
                <div class="content">
                    <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL; ?>weekly_user_product_targets">
                        <div class="row">
                            <div class="col-sm-12">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                               ...
                                               <!--  <a class="btn btn-success" title="assign product targets" style="padding:3px 3px;" href="<?php echo SITE_URL.'assignUserProductTargets/'.@icrm_encode($row['user_id']);?>"><i class="fa fa-pencil"></i>Assign</a> -->
                                                <a class="btn btn-success" title="assign product targets" style="padding:3px 3px;" href="<?php echo SITE_URL.'bulk_upload_weekly_user_product_targets/'.@icrm_encode($row['user_id']);?>"><i class="fa fa-cloud-upload"></i>Upload</a> 
