	...
	<div class="col-md-12 col-sm-12 ">
		<div class="block-flat">
            ...
            <div class="row no-gutter " >
                        <form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL; ?>so_amount_list">
                            <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-2">
                                     ...
                                     <div class="col-sm-3">
                                            <button type="submit" name="search" value="1" class="btn btn-success"><i class="fa fa-search"></i></button>
                                             <button type="submit" name="download" title="" class="btn btn-success" formaction="<?php echo SITE_URL; ?>download_so_bulk_upload" value="download"><i class="fa fa-cloud-download"></i> </button>
                                             <a href="<?php echo SITE_URL; ?>so_amount_list" class="btn btn-success" title="Download"><i class="fa fa-refresh"></i></a>
                                            
                                             <a href="<?php echo SITE_URL.'outstanding_amount_upload'?>" class="btn btn-success" title="Back"><i class="fa fa-reply"></i></a>
                                     </div>  
                             </div>
                        </form>
                    </div>
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td  class="text-center">
                                                <?php
                                                $count=get_uploaded_file_data($row['upload_id']);
                                                if($count>0)
                                                {
                                                   ?>
                                                   <a href="<?php echo SITE_URL; ?>download_so_bulk_upload_details/<?php echo @icrm_encode($row['upload_id']); ?>" style="padding:3px 3px;" title="Download"><button type='button' class="btn btn-primary" style="padding: 3px;" ><i class="fa fa-cloud-download"></i></button></a> <?php
