                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-2">
                                        ...
                                        <button type="submit" value="1" name="download" formaction="<?php echo SITE_URL.'download_stock_in_hand_xl'?>" class="btn btn-primary" title="Download Product Excel"><i class="fa fa-cloud-download"></i></button>
                                    </div>
                                    <div class="col-sm-3">
                                        <?php
                                        if($as_on_date!='')
                                        {
                                            ?>
                                            <span><strong style="color: red;">Last Updated On: </strong><?php echo date('d-m-Y',strtotime($as_on_date));?></span> <?php
                                        }
                                        ?>
                                    </div>
                                </div>
                                                                                        ...
                                                                                        foreach($value2['products'] as $key3 => $value3)
                                                                                        {
                                                                                            if($value3['quantity']>0)
                                                                                            {
                                                                                                ...
                                                                                                <tr class="asset_row">
                                                                                                    ...
                                                                                                    <td align="right"><?php echo $value3['quantity'];?></td>
                                                                                                </tr> <?php
                                                                                            }
                                                                                        }?>
                                                                                    </tbody>
