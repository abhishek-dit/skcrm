            ...
            <div class="block-flat">
                ...
                <form id="bulkUploadFrm1" action="<?php echo SITE_URL.'insert_new_so_amount_upload';?>" method="post"  enctype="multipart/form-data" class="form-horizontal">
                     <div class="col-sm-12 col-md-12" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-3"><a href="<?php echo SITE_URL.'generate_new_so_outstanding_xl'?>" class="btn btn-primary"><i class="fa fa-cloud-download"></i> SO Outstanding Template XLSX</a></div>
                    </div>
