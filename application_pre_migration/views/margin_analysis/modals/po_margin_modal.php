				...
				<div class="m-header">
					<div class="row">
						<div class="col-md-offset-1 col-md-8" style="margin-top: 7px;">
							<label>Purchase Order ID <span style="margin-left:10px;">:</span><span style="margin-left: 15px;"><?php echo $row['purchase_order_id'];?></span></label>
						</div>
					</div>
				</div>
						...
						<table id="table1" style="width:100%" class="kstyle" cellspacing="0" border="1">
	                        ...
	                        <tbody>
	                        	...
	                        	<tr>
		                            ...
		                            <td><?php echo indian_format_price(round($orow['mrp']/$orow['qty']));?></td>
		                            <td><?php echo $discount_percentage;?></td>
		                            <td><?php echo indian_format_price(round($order_value/$orow['qty']));?></td>
		                            <td><?php echo indian_format_price(round($orow['dp']/$orow['qty']));?></td>
		                        </tr>
	                        		<?php
	                        	}
	                        	?>
