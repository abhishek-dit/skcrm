                            ...
                            <div class="form-group" >
                                <div class="col-sm-12" style="margin-top: 10px">
                                    ...
                                    <div class="col-sm-2" align="right">
                                        ...
                                        <?php if($this->session->userdata('role_id')==5) 
                                        { 
                                            if($enable_po_upload_check==1)
                                            {
                                                if($check>0)
                                                {
                                                    $disabled='disabled';
                                                    $title='Attach PO Documents for Approved PO';
                                                }
                                                else
                                                { 
                                                    $disabled='';
                                            ...
                                            ?>
                                            <a href="<?php echo SITE_URL; ?>add_po" <?php echo $disabled;?> title="<?php echo $title;?>" class="btn btn-success" onmouseover="this.title='<?php echo $title;?>';"><i class="fa fa-plus"></i></a>
                                        <?php }?>
                                    </div> 
                                </div>
                            </div> 
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                    <input type="number" required value="<?php echo @$po_results['balance_payment_days'];?>" disabled  class="form-control">
                                    ...
                                    <tr class="product_row">
                                        ...
                                        <td>
                                         <?php
                                            ...
                                            <select class="segment form-control" style="width:100%" name="product_segment_id[]">
                                        ...
                                        <td>
                                            <select class="select3 product_list" style="width:100%" name="product_id[]">
                                        ...
                                        <td>
                                            <input type='number' min="1" class='form-control only-numbers product_qty' name='qty[]'/>
                                        </td>
                                        <td class="discount_block">
                                            ...
                                            <input type="number" min="0" max="100" name="discount[]" class="form-control discount" style="width:100px;display:inline"></td>
                                        </td>
                                        <td>
