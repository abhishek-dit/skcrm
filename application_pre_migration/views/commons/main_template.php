			...
			<div class="cl-navblock">
				<div class="menu-space">
					<div class="content">
						...
						<?php } if($_SESSION['role_id'] == 15) {  // OTR?>
						...
						<?php if($_SESSION['role_id'] == 2){ ?>	
							...
							<li <?php if($cur_page=='channel_partner') echo 'class="active"';?>><a href="<?php echo SITE_URL; ?>channel_partner"><i class="fa fa-puzzle-piece"></i><span>Channel Partner</span></a></li>
						...
						{
							?>
							<li <?php if($cur_page=='po_list') echo 'class="active"';?>><a href="<?php echo SITE_URL; ?>po_list"><i class="fa fa-shopping-cart"></i><span>Purchase Order</span></a></li>
							
							<li <?php if($cur_page=='product_opening_stock_details') echo 'class="active"';?>><a href="<?php echo SITE_URL; ?>product_opening_stock_details"><i class="fa  fa-pencil"></i><span>Opening Stock Entry</span></a></li>
							<li <?php if($cur_page=='distributor_stock_details') echo 'class="active"';?>><a href="<?php echo SITE_URL; ?>distributor_stock_details"><i class="fa fa-building-o"></i><span>Stock Details</span></a></li>
							<li <?php if($cur_page=='commission_report') echo 'class="active"';?>><a href="<?php echo SITE_URL; ?>commission_report"><i class="fa fa-money"></i><span>Commission</span></a></li>
							<?php
						}
