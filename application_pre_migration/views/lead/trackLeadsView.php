					...
					<div class="row">
						<form class="form-horizontal" role="form" action="#" method="post">	
							...
							<div class="form-group">
                                    <div class="col-sm-12">
                                        <div class="col-sm-3">
                                        	<select name="campaign" style="width:100%" class="checkCampaign">
                                        		<option value="<?php echo $s_cam['campaign_id']; ?>"><?php echo $s_cam['campaign']; ?></option>
                                        	</select>   
                                        </div>
                                        <div class="col-sm-3">
					...
					<table class="table table-bordered hover">
						...
						<?php
							...
							if(@$total_rows>0)
							{
								...
								{?>
									<tr>
										<td class="text-center" style="width:8%;"><?php echo @$row['lead_id'];?></td>
										...
										<td class="text-center" style="width:7%;">
											<?php $edit = ($row['user_id'] == $this->session->userdata('user_id'))?'fa-edit (alias)':'fa-info'; ?>
