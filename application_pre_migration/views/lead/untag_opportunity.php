    ...
    <div class="block-flat">
      <div class="content">
        <div class="header">
          ...
          <form class="form-horizontal" role="form" action="<?php echo SITE_URL.'tag_opportunity/'.icrm_encode($po_id);?>" method="post">
            ...
            <div class="row">
              <div class="form-group">
                <div class="col-sm-12">
                  ...
                  <div class="col-sm-3">
                    <select class="test-category form-control" multiple name="product_id[]">
                      <?php
        ...
        <form method="post" action="<?php echo SITE_URL.'add_po_opportunity'?>" >
            <input type="hidden" name="po_id" value="<?php echo $po_id; ?>">
            <input type="hidden" name="tag"  value=2 >
        <?php if(count($opportunties_tagged)>0) { ?>
        <div class="table-responsive">
          <table class="table table-bordered hover">
            <thead class="table-bordered">
              <tr>
                <th ><input type="checkbox" id="checkAll" name="checkAll"></th>
                <th class="text-center"><strong>Opp ID</strong></th>
            ...
            <?php
              ...
              if(@count($searchResults)>0)
              {
                ...
                {  
                  if($row1['opportunity_id']==@$opportunities[$row1['opportunity_id']]['opportunity']) {
                   ?>
                  
                  <!--<a data-toggle="tooltip" href="#" data-original-title="Default tooltip">Jeff Hanneman</a>-->
                  <tr>
                   <td> <input type="checkbox"  class="chkAll openOrder" name="opp_id[]" value="<?php echo $row1['opportunity_id'];?> " ></td>
                    ...
                    <td class="text-center" style="width:9%;"><?php echo indian_format_price(@$row1['required_quantity']*@$row1['rrp']);?></td>                    
                    <?php if($pageInfo == 1) { ?>
            ...
            <?php } }
                ...
                $colspan = 10;
              ?>  <tr><td colspan="<?php echo $colspan; ?>" align="center"><span class="label label-primary">No Opportunity is created For this PO</span></td></tr>
          <?php   } ?>
            </tbody>
          </table>
        </div>
        ...
        <div class="row">
            <div class="form-group" >
                    <div class="col-sm-offset-5 col-sm-10">
                        ...
                        <button class="btn btn-danger" type="submit" name="tag_submit" value="button"><i class="fa fa-unlink"></i>UnTag</button>
          ...
          { ?>
              ...
              <div class="block-flat">
                ...
                <div class="content" >
                  <p align="center" ><b>Sorry ! Opportunites are Not tagged for this Purchase Order :<?php echo $po_id ; ?> </b></p>
                </div>
              </div>        
          </div>  
            <div class="row">
