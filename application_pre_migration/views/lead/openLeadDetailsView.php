					...
					<div class="form-group no-padding">
						...
						<?php if($checkUser && $checkPage) { ?>
							...
							<?php if($leadStatus == 5 || $leadStatus == 10) { ?>
								<button class="btn btn-danger" type="submit"  formaction="<?php echo SITE_URL; ?>closeLead" name="closeLead" value="1"><i class="fa  fa-times"></i> Close Lead</button>
							<?php } ?>
						<?php } ?>	
						</div>
					</div>
				...
				<form class="form-horizontal lead_form" id="leadDetailsForm" method="post" action="<?php echo SITE_URL.$formAction?>" data-parsley-validate novalidate>
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-10">
							...
							<a href="<?php echo SITE_URL;?>openLeadDetails/<?php echo $encode_lead_id; ?>"><button type="button" class="btn btn-danger" ><i class="fa fa-times"></i> Cancel</button></a>
						</div>
					</div>
					<?php } ?>
				</form>	
