            ...
            <?php
              ...
              if(@count($searchResults)>0)
              {
                ...
                {?>
                  ...
                  <tr>
                  <?php
                   if(@$opportunities[$row1['opportunity_id']]['opportunity'] == $row1['opportunity_id'])
                   { ?>
                       <td></td>
                  <?php } 
                   else
        ...
        <div class="row">
            <div class="form-group">
                    <div class="col-sm-offset-5 col-sm-10">
                        <button class="btn btn-primary" type="submit" name="tag_submit" value="button"><i class="<?php echo "fa fa-link";?>"></i>Tag</button>
