	...
	<?php
		if(@$flg!='')
		{
			...
			if($flg == 1)
			{
				...
				if($val == 1)
				{
					$loc = @$cityEdit[0]['location_id'];
					$formHeading = 'Edit City Details';
				}
				else
				{
					$formHeading = 'Add New City';
				}
				?>
					<div class="row"> 
							...
							<div class="block-flat">
								...
								<div class="content">
									<form class="form-horizontal" role="form" action="<?php echo SITE_URL; ?>locationAdd"  parsley-validate novalidate method="post">
										...
										<input type="hidden" name="location_id" value="<?php echo @$cityEdit[0]['location_id']?>">
										<input type="hidden" name="territory_level_id" value="<?php echo @$territory_level_id ?>">
										<div class="form-group">
											<label for="inputName" class="col-sm-3 control-label">Select District <span class="req-fld">*</span></label>
											<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<div class="col-sm-6">
												<input type="name" required class="form-control" id="name" placeholder="Name" name="name" value="<?php echo @$cityEdit[0]['location']; ?>"  maxlength="100">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-offset-3 col-sm-10">
												<button class="btn btn-primary" type="submit" name="submitLocation" value="button"><i class="fa fa-check"></i> Submit</button>
												<a class="btn btn-danger" href="<?php echo SITE_URL;?>city"><i class="fa fa-times"></i> Cancel</a>
											</div>
										</div>
									</form>
								</div>
...
<div class="row"> 
	<div class="col-sm-12 col-md-12">
		<div class="block-flat">
			...
			<div class="content">
				<form role="form" class="form-horizontal" method="post" action="<?php echo SITE_URL;?>city">
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">
					...
					<div class="row">
						<div class="col-sm-12">
							<div class="form-group">	
								...
								<div class="col-sm-2">
									<?php 
										echo form_dropdown('district', $districtDetails, @$searchParams['district_id'],'class="select2" id="District" '); ?>
								</div>
								<label class="col-sm-2 control-label">City</label>
								<div class="col-sm-2">
									<input type="text" name="cityName" value="<?php echo @$searchParams['cityName'];?>" id="cityName" class="form-control" placeholder="Name"  maxlength="100">
								</div>
								<div class="col-sm-4" align="right">
									<button type="submit" name="searchCity" title="Search" value="1" class="btn btn-success"><i class="fa fa-search"></i> </button>
		                        	<button type="submit" name="downloadCity" value="1" title="Download" formaction="<?php echo SITE_URL;?>downloadCity" class="btn btn-success"><i class="fa fa-cloud-download"></i> </button>
									<a href="<?php echo SITE_URL;?>addCity" title="Add New" class="btn btn-success"><i class="fa fa-plus"></i> </a>
								</div>
							</div>
						</div>
					</div>
								...
								{?>
									<tr>
										...
										<td class="text-center">
											<a class="btn btn-default" style="padding:3px 3px;" href="<?php echo SITE_URL;?>editCity/<?php echo @icrm_encode($row['location_id']); ?>"><i class="fa fa-pencil"></i></a>
										</td>
									</tr>
						<?php	}
							} else {
