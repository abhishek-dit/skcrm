        ...
        <td>
            <table width="100%" border="1" cellspacing="0" cellpadding="2">
                <tr>
                    ...
                    <th width="13%" style="font-size:8px"><strong>Unit Price</strong></th>
                    <th width="5%" style="font-size:8px"><strong>Qty</strong></th>
                    <th width="13%" style="font-size:8px"><strong>Total Price</strong></th>
                </tr>
                <?php
                $cnt = 1;
                ...
                $cnt++; ?></td>
                            ...
                            <td width="13%" style="font-size:8px" valign="top" align="right"><strong><?php echo indian_format_price($mrp); ?></strong></td>
                            <td width="5%" style="font-size:8px" valign="top" align="center"><strong><?php echo $product['qty']; ?></strong></td>
                            <td width="13%" style="font-size:8px" valign="top" align="right"><strong><?php echo indian_format_price($total_amt); ?></strong></td>
                        </tr>
                        <?php
                    }
