            ...
            <div class="content">
                ...
                <input type="hidden" name="lead_id" value="<?php echo @$lead_id; ?>">
                                            ...
                                            foreach ($opportunities as $v) {
                                                ...
                                                <tr class="quote_opprow op_row">
                                                    ...
                                                    <td>
                                                        ...
                                                        <select name="discount_type[<?php echo $v['opportunity_id']; ?>]" class="discount_type form-control" style="width:70px;display:inline">
                                                        <?php
                                                    ...
                                                    <input type="number" min="0" max="100" step=".01" name="discount[<?php echo $v['opportunity_id']; ?>]" class="form-control op_discount" style="width:150px;display:inline"></td>
                                                    <td>
                                                        <input type="checkbox" checked="" class="op hidden" value="<?php echo $v['opportunity_id']; ?>">
                                                        <input type="hidden"  value="<?php echo $v['required_quantity']*$v['mrp']; ?>" class="order_val" >
                                                        <span class="discounted_value"></span>
                                                    </td>
                                                </tr>
                                                <tr class="free_row">
                                                    <td colspan="1">
                                                                ...
                                                                <tr class="free_product_row">
                                                                    ...
                                                                    <td>
                                                                     <?php
                                                                        ...
                                                                        <select class="select3 free_item_product" style="width:100%" name="product_id[<?php echo $v['opportunity_id'];?>][]">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        id="qty_1" name='qty[<?php echo $v['opportunity_id'];?>][]'/>
                                                                    </td>
                                                                     <td colspan="3">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="number" class="form-control" min="0" max="100" placeholder="Advance Collected" value="<?php echo $row['advance'];?>" name="advance" id="advance_collected" required>
                        </div>
                    </div>
                    <?php  
                    if($row['advance_type']==1&&$row['advance']==100)
                    {
                    ...
                    <div class="form-group" id="dealer_commission_row">
                        ...
                        <div class="col-sm-7">
                            <input type="number" id="dealer_commission" class="form-control" min="0" max="100" placeholder="Dealer Commission (%)" name="dealer_commission" value="<?php echo $row['dealer_commission'];?>">
                        </div>
                    </div>
