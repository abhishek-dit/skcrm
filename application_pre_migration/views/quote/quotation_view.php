...
<html>
<head>
    <title>Skanray_Quote-<?php echo $ref;?></title>
    <style type="text/css">
        html {
            display: table;
            margin: auto;
...
<table  width="<?php echo $table_width; ?>" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" >
    ...
    <tr> <td width="5">&nbsp;</td>
        <td><p>Thank you for your interest in Skanray’s products. We are confident that our products will satisfy your clinical requirements. 
            ...
            <p>Yours truly,<br><?php if($quotation['roleCheck'] == 1) { ?>Skanray Technologies Pvt. Ltd<?php } 
            else{ echo $quotation['lead_owner']['distributor']; } ?><br><br>
            <p><?php echo $quotation['quote_creator']['name']; ?><?php if($quotation['roleCheck'] == 1) { ?><br><?php echo $quotation['quote_creator']['role']; } ?></p></p><span style="font-size:12px">*This is an electronically generated quotation, no signature required.</span>
    ...
    <?php if(@$quotation['bank_details']['channel_type']==1) { ?>
     <tr> <td width="5">&nbsp;</td>
        ...
        <td style="overflow-wrap: break-word;padding-left: 181px;padding-right: 210px;font-size: small;" width="5%" valign="top"  >
    ...
    <tr> <td width="5">&nbsp;</td>
        <td>
            <h2>Commercial Offer<span style="font-size:12px; font-weight:normal;"> (All values in Rupees)</span></h2> <br><br><br></td> <td width="5">&nbsp;</td>
    </tr>
<?php $description_width = 48;?>
    <tr> <td width="5">&nbsp;</td>
        <td>
            <table width="100%" border="1" class="table_border" cellspacing="0" cellpadding="2">
                <tr>
                    <th width="5%" style=""><strong>Sno</strong></th>
                    <th width="17%" style=""><strong>Material Part #</strong></th>
                    <th width="<?php echo $description_width;?>%" style=""><strong>Material Description</strong></th>
                    <th width="13%" style=""><strong>Unit Price</strong></th>
                    <th width="5%" style=""><strong>Qty</strong></th>
                    <th width="13%" style=""><strong>Total Price</strong></th>
                </tr>
                <?php
                $cnt = 1;
                $grand_total = 0; $total_discount = 0; $sub_total = 0;
                if (count($quotation['product_details']) > 0) {
                    foreach ($quotation['product_details'] as $product) {
                        ...
                        if($discount_type==1) // In %
                        {
                            ...
                            $discount_amt = round(get_percentage($mrp*$product['qty'], $discount)); 
                        }
                        else // In Rs
                        {
                        ...
                        $total_amt = ($mrp*$product['qty']);
                        $sub_total+=$total_amt;
                        ?>
                        <tr>
                            <td width="5%" style="" align="center" valign="top"><?php echo $cnt;
                $cnt++; ?></td>
                            <td width="17%" style="" valign="top"><?php echo $product['name']; ?></td>
                            <td width="<?php echo $description_width;?>%" style="" valign="top"> <?php echo $product['description'];?></td>
                            <td width="13%" style="" valign="top" align="right"><strong><?php echo indian_format_price($mrp); ?></strong></td>
                            <td width="5%" style="" valign="top" align="center"><strong><?php echo $product['qty']; ?></strong></td>
                            <td width="13%" style="" valign="top" align="right"><strong><?php echo indian_format_price($total_amt); ?></strong></td>
                        </tr>
                        <?php
                    }
                    ...
                    if(count(@$free_supply_items)>0)
                    {
                        foreach ($free_supply_items as $frow) {
                            ...
                            <tr>
                                <td width="5%" style="" align="center" valign="top"><?php echo $cnt;
                    $cnt++; ?></td>
                                <td width="17%" style="" valign="top"><?php echo $frow['name']; ?></td>
                                <td width="<?php echo $description_width;?>%" style="" valign="top"> <?php echo $frow['description'];?></td>
                                <td width="13%" style="" valign="top" align="right"><strong>0</strong></td>
                                <td width="5%" style="" valign="top" align="center"><strong><?php echo $frow['quantity']; ?></strong></td>
                                <td width="13%" style="" valign="top" align="right"><strong>0</strong></td>
                            </tr>
                            <?php
                        }
        ...
        <td>
            <table width="100%" border="1" class="table_border" cellspacing="0" cellpadding="2">
                ...
                <tr>
                    ...
                    <td width="13%" valign="top" align="right" style="" >
                ...
                if ($total_discount > 0) {
                    ...
                    <tr>
                        ...
                        <td valign="top" width="13%" align="right" style="" >
                ...
                <?php } 
                    ...
                    $new_sub_total = $sub_total+$freight;
                ...
                <tr>
                    ...
                    <td valign="top" align="right" width="13%"  style="" >
                ...
                <tr>
                    <td width="5%" align="center" valign="top">&nbsp;</td>
                    <td  width="<?php echo $sub_total_width?>%">Total Price - F.O.R Destination in Indian Rs.
                    </td>
                    <td valign="top" align="right" width="13%" style="" >
                        <strong><?php
                ...
                <tr>
                    <td width="5%" align="center" valign="top">&nbsp;</td>
                    <td width="<?php echo $sub_total_width?>%">Total Price in words - Indian Rs. (<?php echo ucwords(convert_number_to_words($final_amt)); ?> Only)
                    </td>
                    ...
                    <td width="100%">
                        <ol>
                            ...
                            switch ($tax_type) {
                                case 1: // ED, VAT
                                    ?>
                                    <li>The above prices are in Indian Rs. & inclusive of currently applicable ED & Sales Tax. Any change in these rates at the time of billing, will be extra to your account, at actual.</li>
                                    <li>Octroi, LBT, Entry tax etc., if applicable, will be extra to your account, at actual.</li>
                                    <?php
                                break;
                                case 2: // GST
                                ?>
                                    <li>The above prices are in Indian Rs. & inclusive of currently applicable GST. Any change in these rates at the time of billing, will be extra to your account, at actual.</li>
                                <?php
                                break;
                            }
                            ?>
...
<tr> <td width="5">&nbsp;</td>
    <td  align="left">
        ...
        <div style=" text-align:justify;">The foregoing terms & conditions shall prevail notwithstanding any variations contained in any document received from the customer, unless such variations have been specifically agreed upon in writing by Skanray Technologies Private Limited.
        </div>
    </td>
 <td width="5">&nbsp;</td>
</tr>
