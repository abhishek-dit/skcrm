		...
		if($this->input->post('submit'))
		{
            ...
            {   
				...
				$this->session->set_flashdata('response','<div class="alert alert-success alert-white rounded">
								...
								<strong>Success!</strong> Financial Year for ('.$start_date.' to '.$end_date.') added successfully!
							 </div>');
			...
			else
			{
				$this->session->set_flashdata('error','<div class="alert alert-danger alert-white rounded">
										<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
										<div class="icon"><i class="fa fa-check"></i></div>
										<strong>Error!</strong> Start Date ('.$start_date.') should be less than End Date ('.$end_date.')!
									 </div>');
