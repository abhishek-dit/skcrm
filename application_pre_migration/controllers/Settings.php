...
class Settings extends Base_controller {
    ...
    public function incentive_settings()
    {
        ...
        $data['fy_year']=$this->Common_model->get_data('financial_year',array('status'=>1));
    ...
    public function incentive_insert_settings()
    {
    	...
    	$check=$this->Common_model->get_data_row('incentives',array('fy_id'=>$fy_id,'role_id'=>$role_id,'status'=>1));
