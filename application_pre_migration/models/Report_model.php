...
class Report_model extends CI_Model {
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,l4.location,l4.location_id,cn.contract_note_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
...
/*		$where=' cn.contract_note_id != (select min(cn1.contract_note_id) from contract_note cn1  inner join contract_note_quote_revision cnqr1 on cn1.contract_note_id=cnqr1.contract_note_id inner join quote_revision qr1 on cnqr1.quote_revision_id=qr1.quote_revision_id inner join quote_details qd1 on qr1.quote_id=qd1.quote_id inner join opportunity o1 on qd1.opportunity_id=o1.opportunity_id inner join lead l1 on o1.lead_id=l1.lead_id where c.customer_id=l1.customer_id)';*/
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,pg.name,pg.group_id,cn.contract_note_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,p.product_id,p.description as name,cn.contract_note_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,c.customer_id,c.name as c_name,cn.contract_note_id,GROUP_CONCAT(DISTINCT(cn.contract_note_id) SEPARATOR ",") as c_noteid,c.customer_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,l.user_id,u.first_name as name,cn.contract_note_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,p.product_id,cn.contract_note_id,c.name as c_name,GROUP_CONCAT(DISTINCT(cn.contract_note_id) SEPARATOR ",") as c_noteid,c.customer_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	public function get_cn_by_users($region_name,$searchfilters)
	{
		...
		$this->db->select('concat(u.first_name," ",u.last_name," (",u.employee_id,")") as name,sum(qd.mrp) as total_value');
	...
	public function get_cn_by_customers($region_name,$employee_id,$searchfilters)
	{
		...
		$this->db->select('c.name,sum(qd.mrp) as total_value');
		$this->db->from('customer c');
		$this->db->join('lead l','c.customer_id=l.customer_id','inner join');
		$this->db->join('user u','l.user_id=u.user_id');
		$this->db->join('opportunity o','l.lead_id=o.lead_id','inner join');
	...
	{   
		...
		$this->db->select('sum(case when cn.status=3 then ( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END ) else 0 end ) as cfi,
 			sum(case when cn.status=1 then ( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END ) else 0 end ) as so, cn.status');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select('sum(case when cn.status=3 then ( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END ) else 0 end ) as pcfi,
 			sum(case when cn.status=1 then ( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END ) else 0 end ) as pso, cn.status');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	public function get_open_orders_by_segment($status,$category,$searchfilters)
	{
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,pg.name,pg.group_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	public function get_previous_open_orders_by_segment($status,$category,$searchfilters)
	{
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS previous_total_orders,pg.name,pg.group_id');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select(' ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,c.name,l5.location');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	{   
		...
		$this->db->select(' ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN (o.required_quantity*qd.mrp)*(1-qr.discount/100) ELSE ( CASE WHEN ma.discount_type = 1 THEN (o.required_quantity*qd.mrp)*(1-ma.discount/100) ELSE (o.required_quantity*qd.mrp)-ma.discount END ) END )) AS total_orders,sum(o.required_quantity) as stock,p.product_id,pg.name as segment_name,p.description as product_description,p.name as product_name');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
	...
	public function get_previous_sales($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS previous_sales');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_current_sales($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS current_sales');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_open_orders($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS open_orders');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
...
public function get_open_opportunity($user_id, $role_id, $userProducts, $userLocations, $hotDay, $warmDate,$searchfilters)
	...
	public function get_previous_sales_category($searchfilters,$category_id,$group_id,$product_id,$ss='')
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS previous_sales,p.product_id');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_current_sales_category($searchfilters,$category_id,$group_id,$product_id,$ss='')
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS current_sales,p.product_id');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_open_orders_category($searchfilters,$category_id,$group_id,$product_id,$ss='')
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS open_orders,p.product_id');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
...
/*		$this->db->join('weekly_user_product_target wupt','p.product_id=wupt.product_id and op.product_id=wupt.product_id');*/
	...
	public function get_previous_sales_by_region($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS previous_sales,l4.location,l4.location_id');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_current_sales_by_region($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS current_sales,l4.location,l4.location_id');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_open_orders_by_region($searchfilters)
	{
		...
		elseif($searchfilters['measure']==2)
		{
			$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS open_orders,l4.location_id,l4.location');
		}
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
	...
	public function get_funnel_sales($searchfilters)
	{
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS current_sales,DATE_FORMAT(cn.created_time,"%b-%y") as timeline,month(cn.created_time) as ctime');
	...
	public function get_incentives_financial_year()
	{
		$this->db->select('*');
	...
	public function get_incentive_user_sales($users_id,$searchfilters,$userLocations,$userProducts,$category_id,$role_id)
	{
		...
		$this->db->select('ROUND(SUM( CASE WHEN ma.margin_approval_id IS NULL THEN ((o.required_quantity*qd.mrp)*(1-qr.discount/100))/100000 ELSE ( CASE WHEN ma.discount_type = 1 THEN ((o.required_quantity*qd.mrp)*(1-ma.discount/100))/100000 ELSE ((o.required_quantity*qd.mrp)-ma.discount)/100000 END ) END ),2) AS current_sales,l4.location as region');
		$this->db->from('contract_note cn');
		$this->db->join('contract_note_quote_revision cnqr','cn.contract_note_id=cnqr.contract_note_id');
		$this->db->join('quote_revision qr','cnqr.quote_revision_id=qr.quote_revision_id');
		$this->db->join('quote_details qd','qr.quote_id=qd.quote_id');
